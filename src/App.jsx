...
function App() {
  ...
  // Scrubbed baseline data for GitHub demonstration
  const initialGrades = [
    // Winter 25/26
    { name: "Global Security Theory", grade: "5.0", ects: 5, category: "High Impact", semester: 'Winter 25/26' },
    { name: "Advanced Analytics", grade: "5.0", ects: 3, category: "Core", semester: 'Winter 25/26' },
    { name: "Behavioral Economics", grade: "5.0", ects: 5, category: "High Impact", semester: 'Winter 25/26' },
    { name: "Language acquisition course", grade: "5.0", ects: 4, category: "Language", semester: 'Winter 25/26' },
    ...
    // Summer 24/25
    { name: "Advanced Policy Theory", grade: "5.0", ects: 5, category: "Core", semester: 'Summer 24/25' },
    { name: "Strategic Management", grade: "5.0", ects: 4, category: "Core", semester: 'Summer 24/25' },
    ...
    // Winter 24/25
    { name: "Core Fundamentals", grade: "5.0", ects: 5, category: "Foundation", semester: 'Winter 24/25' },
