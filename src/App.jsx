...
function App() {
 ...
 const initialGrades = [
    ...
    // Summer 24/25
    { name: "Migration Movement and Integration of Immigrants", grade: "5.0", ects: 5, category: "Core", semester: 'Summer 24/25' },
    { name: "European Union military capabilities", grade: "5.0", ects: 4, category: "Core", semester: 'Summer 24/25' },
    { name: "Shades of populism in Europe and the world", grade: "4.0", ects: 4, category: "Core", semester: 'Summer 24/25' },
